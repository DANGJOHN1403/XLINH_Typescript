...
export const add_product = async () => {
    ...
    let category_id:number = Number((document.querySelector('#category_id') as HTMLInputElement).value);
    ...
    let intro:string = (document.querySelector('#intro') as HTMLInputElement).value;
    let description:string = (document.querySelector('#description') as HTMLInputElement).value;
    let created_date:string = (document.querySelector('#created_date') as HTMLInputElement).value;
...
export const deleteProduct = async (btn: HTMLButtonElement) => {
    let id:string = btn.getAttribute('idpro');
